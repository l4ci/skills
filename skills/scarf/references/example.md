...
**You invoke it with:**
> "Use SCARF on the reorg announcement I'm about to send, I think people will resist it"

**It needs from you:**
- SITUATION (required): "Announcing that the two product squads are merging into one, with a new shared lead, and that three tech leads will become senior ICs reporting to that lead."
- PEOPLE (optional): "The three tech leads losing their lead title, and the ~18 engineers across both squads who don't yet know which manager they'll have."
