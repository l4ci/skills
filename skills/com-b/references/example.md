...
**You invoke it with:**
> "Use COM-B to work out why our field engineers aren't logging safety near-misses in the new app"

**It needs from you:**
- BEHAVIOUR (required): field engineers log every safety near-miss in the mobile app before leaving the site, on the day it happens
- ACTOR (required): the 240 field engineers servicing wind-turbine sites, mostly working solo or in pairs
