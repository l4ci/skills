...
It is the long form (240 items, roughly 30–40 minutes); there is no public-domain short version. For a quicker read, the 50-item OCEAN test is the faster five-factor alternative, though it cannot measure Honesty-Humility.
