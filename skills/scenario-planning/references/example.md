...
**You invoke it with:**
> "Run scenario planning on whether we should keep investing in our on-prem product line over the next decade"

**It needs from you:**
- FOCAL QUESTION (required): "How should our mid-market data-infrastructure company position its on-prem product line over the next ten years, given the shift to cloud?"
- HORIZON (optional): "Ten years (2026-2036)"
